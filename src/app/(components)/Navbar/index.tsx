    ...
    return (
        <div className="flex justify-between items-center w-full mb-7">
            ...
            <div className="relative">
                <input type="search" placeholder='Buscar categorias y/o productos' className='pl-10 pr-4 py-2 w-50 md:w-80 border-2 border-gray-300 bg-white rounded-lg focus:outline:none focus:border-blue-500' />
